...
<div class="row justify-content-center">
    <div class="list-group">
        ...
        <a href="" class="list-group-item list-group-item-action active">Image Upload</a>
    </div>
</div>
<div class="row justify-content-center">
<form class="my-5" action="upload-complete.php" method="post" enctype="multipart/form-data">
